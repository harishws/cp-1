...
public class App 
{
    ...
    {   
        ...
        {
        updateProduct.setPcost(1,50,000);
        ...
        */
        ...
        User user1=new User();
        user1.setUid("U102");
        user1.setUname("Harish");
        user1.setUemail("wsharish2016@gmail");
        user1.setUpwrd("pass@123");
        user1.setUmobno("9043837460");
        user1.setUlocation("Egmore");
        ...
        supplier1.setSname("hitesh");
        supplier1.setSdesc("mac");
        ...
        {
        updateSupplier.setSdesc("macAir");;
